...
public class test implements AudioSourceManager, HttpConfigurable {
    ...
    public test(String clientID, String clientSecret, String youtubeApiKey,
 ...
 */
            ...
            if (res.matches()) {
                ...
                try {
                    ...
                    return new SpotifyTrack(new AudioTrackInfo(v.getSnippet().getTitle(),
    ...
    public AudioTrack decodeTrack(AudioTrackInfo trackInfo, DataInput input) {
        return new SpotifyTrack(trackInfo, youtubeAudioSourceManager);
    }
